  ...
  return (
    <>
      <div className="grid grid-cols-12 h-[100vh] w-[100vw]">
        ...
        <div className="p-4 md:p-8 col-span-12 flex md:col-span-6 flex-col justify-center h-[100%] md:px-16 lg:px-24 bg-[#F5F5F5] xl:px-32 gap-2">
          ...
          <div className="grid grid-cols-12 gap-2 md:gap-6">
            ...
            <button className="col-span-12 md:col-span-6 rounded-md md:rounded-xl bg-white p-2 text-gray-500 hover:text-gray-700 transition-colors flex gap-2 items-center  px-4 md:px-8">
